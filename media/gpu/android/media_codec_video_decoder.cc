...
std::vector<SupportedVideoDecoderConfig> GetSupportedConfigsInternal(
  ...
  char ro_board_platform[PROP_VALUE_MAX];
  int ro_board_platform_length = __system_property_get("ro.board.platform", ro_board_platform);
  LOG(ERROR) << ro_board_platform;
  if (ro_board_platform_length > 0 && strcmp(ro_board_platform, "rk3188") == 0) {
