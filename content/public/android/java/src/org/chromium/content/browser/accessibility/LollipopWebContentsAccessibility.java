...
public class LollipopWebContentsAccessibility extends WebContentsAccessibilityImpl {
    ...
    LollipopWebContentsAccessibility(AccessibilityDelegate delegate) {
        super(delegate);
    }
    ...
    @Override
    protected void setAccessibilityNodeInfoBaseAttributes(
            AccessibilityNodeInfo node, boolean isRoot,
        ...
        super.setAccessibilityNodeInfoBaseAttributes(
                node, isRoot, className, role, roleDescription, hint, targetUrl, canOpenPopup,
                dismissable, multiLine, inputType, liveRegion, errorMessage);
