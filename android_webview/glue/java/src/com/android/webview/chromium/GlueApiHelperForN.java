...
public final class GlueApiHelperForN {
     ...
     */
    public static ServiceWorkerController createDefaultServiceWorkerControllerAdapter(
            WebViewChromiumAwInit awInit) {
        return new ServiceWorkerControllerAdapter(awInit.getDefaultServiceWorkerController());
    }
