...
import com.android.webview.chromium.WebViewChromium2.ApiCall;
...
public class ContentSettingsAdapter2 extends android.webkit.WebSettings {
    ...
    public void setSupportZoom(boolean support) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SUPPORT_ZOOM);
    ...
    public boolean supportZoom() {
        try (TraceEvent event =
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SUPPORT_ZOOM);
    ...
    public void setBuiltInZoomControls(boolean enabled) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_BUILT_IN_ZOOM_CONTROLS);
    ...
    public boolean getBuiltInZoomControls() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_BUILT_IN_ZOOM_CONTROLS);
    ...
    public void setDisplayZoomControls(boolean enabled) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_DISPLAY_ZOOM_CONTROLS);
    ...
    public boolean getDisplayZoomControls() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_DISPLAY_ZOOM_CONTROLS);
    ...
    public void setAllowFileAccess(boolean allow) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_ALLOW_FILE_ACCESS);
    ...
    public boolean getAllowFileAccess() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_ALLOW_FILE_ACCESS);
    ...
    public void setAllowContentAccess(boolean allow) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_ALLOW_CONTENT_ACCESS);
    ...
    public boolean getAllowContentAccess() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_ALLOW_CONTENT_ACCESS);
    ...
    public void setLoadWithOverviewMode(boolean overview) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_LOAD_WITH_OVERVIEW_MODE);
    ...
    public boolean getLoadWithOverviewMode() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_LOAD_WITH_OVERVIEW_MODE);
    ...
    public void setSafeBrowsingEnabled(boolean accept) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SAFE_BROWSING_ENABLED);
    ...
    public boolean getSafeBrowsingEnabled() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_SAFE_BROWSING_ENABLED);
    ...
    public void setSaveFormData(boolean save) {
        ...
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SAVE_FORM_DATA);
    ...
    public boolean getSaveFormData() {
        ...
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_SAVE_FORM_DATA);
    ...
    public synchronized void setTextZoom(int textZoom) {
        try (TraceEvent event =
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_TEXT_ZOOM);
    ...
    public synchronized int getTextZoom() {
        try (TraceEvent event =
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_TEXT_ZOOM);
    ...
    public synchronized void setUserAgent(int ua) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_USER_AGENT);
    ...
    public synchronized void setUseWideViewPort(boolean use) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_USE_WIDE_VIEW_PORT);
    ...
    public synchronized boolean getUseWideViewPort() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_USE_WIDE_VIEW_PORT);
    ...
    public synchronized void setSupportMultipleWindows(boolean support) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SUPPORT_MULTIPLE_WINDOWS);
    ...
    public synchronized boolean supportMultipleWindows() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SUPPORT_MULTIPLE_WINDOWS);
    ...
    public synchronized void setLayoutAlgorithm(LayoutAlgorithm l) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_LAYOUT_ALGORITHM);
            switch (l) {
                case NORMAL:
    ...
    public synchronized LayoutAlgorithm getLayoutAlgorithm() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_LAYOUT_ALGORITHM);
    ...
    public synchronized void setStandardFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_STANDARD_FONT_FAMILY);
    ...
    public synchronized String getStandardFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_STANDARD_FONT_FAMILY);
    ...
    public synchronized void setFixedFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_FIXED_FONT_FAMILY);
    ...
    public synchronized String getFixedFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_FIXED_FONT_FAMILY);
    ...
    public synchronized void setSansSerifFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SANS_SERIF_FONT_FAMILY);
    ...
    public synchronized String getSansSerifFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_SANS_SERIF_FONT_FAMILY);
    ...
    public synchronized void setSerifFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_SERIF_FONT_FAMILY);
    ...
    public synchronized String getSerifFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_SERIF_FONT_FAMILY);
    ...
    public synchronized void setCursiveFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_CURSIVE_FONT_FAMILY);
    ...
    public synchronized String getCursiveFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_CURSIVE_FONT_FAMILY);
    ...
    public synchronized void setFantasyFontFamily(String font) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_FANTASY_FONT_FAMILY);
    ...
    public synchronized String getFantasyFontFamily() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_FANTASY_FONT_FAMILY);
    ...
    public synchronized void setMinimumFontSize(int size) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_MINIMUM_FONT_SIZE);
    ...
    public synchronized int getMinimumFontSize() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_MINIMUM_FONT_SIZE);
    ...
    public synchronized void setMinimumLogicalFontSize(int size) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(
    ...
    public synchronized void setDefaultFontSize(int size) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_DEFAULT_FONT_SIZE);
    ...
    public synchronized int getDefaultFontSize() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_DEFAULT_FIXED_FONT_SIZE);
    ...
    public synchronized void setDefaultFixedFontSize(int size) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_DEFAULT_FIXED_FONT_SIZE);
    ...
    public synchronized void setBlockNetworkImage(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_BLOCK_NETWORK_IMAGE);
    ...
    public synchronized boolean getBlockNetworkImage() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_BLOCK_NETWORK_IMAGE);
    ...
    public synchronized void setBlockNetworkLoads(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_BLOCK_NETWORK_LOADS);
    ...
    public synchronized boolean getBlockNetworkLoads() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_BLOCK_NETWORK_LOADS);
    ...
    public synchronized void setJavaScriptEnabled(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_JAVA_SCRIPT_ENABLED);
    ...
    public synchronized void setPluginState(PluginState state) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_PLUGIN_STATE);
            mPluginState = state;
        }
    }
    ...
    public synchronized void setDatabaseEnabled(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_DATABASE_ENABLED);
    ...
    public synchronized void setDomStorageEnabled(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_DOM_STORAGE_ENABLED);
    ...
    public synchronized boolean getDomStorageEnabled() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_DOM_STORAGE_ENABLED);
    ...
    public synchronized boolean getDatabaseEnabled() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_DATABASE_ENABLED);
    ...
    public synchronized void setGeolocationEnabled(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_GEOLOCATION_ENABLED);
    ...
    public synchronized boolean getJavaScriptEnabled() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_JAVA_SCRIPT_ENABLED);
    ...
    public synchronized PluginState getPluginState() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_PLUGIN_STATE);
            return mPluginState;
        }
    }
    ...
    public synchronized void setUserAgentString(String ua) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_USER_AGENT_STRING);
    ...
    public synchronized String getUserAgentString() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_USER_AGENT_STRING);
    ...
    public void setNeedInitialFocus(boolean flag) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_NEED_INITIAL_FOCUS);
    ...
    public void setCacheMode(int mode) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_CACHE_MODE);
    ...
    public int getCacheMode() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_CACHE_MODE);
    ...
    public void setMixedContentMode(int mode) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_MIXED_CONTENT_MODE);
    ...
    public int getMixedContentMode() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_MIXED_CONTENT_MODE);
    ...
    public void setOffscreenPreRaster(boolean enabled) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_OFFSCREEN_PRE_RASTER);
    ...
    public boolean getOffscreenPreRaster() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_OFFSCREEN_PRE_RASTER);
    ...
    public void setForceDark(int forceDarkMode) {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_SET_FORCE_DARK);
    ...
    public int getForceDark() {
        try (TraceEvent event = TraceEvent.scoped(
            ...
            WebViewChromium2.recordWebViewApiCall(ApiCall.WEB_SETTINGS_GET_FORCE_DARK);
            if (AwDarkMode.isSimplifiedDarkModeEnabled()) {
